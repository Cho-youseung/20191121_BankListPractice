package com.tjoeunit.a20191121_banklistpractice.utils
...
class ConnectServer {
    ...
    companion object {
        ...
        fun getRequestUserList(context: Context, needActivity: String, handler: JsonResponseHandler?) {
            ...
            var requestUri = urlBuilder.build().toString()
